layui.use(['table','layer'],function(){
    ...
    var tableIns = table.render({
        ...
        ,cols: [[
            ...
            ,{field: 'teacherId', title: '编号',  sort: true, fixed: 'left'}
            ,{field: 'teacherName', title: '教师姓名', align:'center'}
            ,{field: 'sex', title: '性别', align:'center'}
            ,{field: 'teacherIdcard', title: '身份证号码', align:'center'}
            ,{field: 'teacherPhone', title: '联系方式', align:'center'}
    ...
    function openSaleChanceDialog(saleChanceId) {
        ...
        if (saleChanceId != null && saleChanceId != '') {
            ...
            // 请求地址传递营销机会的ID
            url = ctx + "/sale_chance/addOrUpdateSaleChancePage" + '?saleChanceId=' + saleChanceId;
        }
